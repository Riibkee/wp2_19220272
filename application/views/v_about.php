<section>
 ...
 <li>Bangkit kembali dari kekesalan dan kekecewaan</li>
 <li>Memiliki hubungan yang lebih sehat dengan keluarga dan teman</li>
 <li>Melakukan aktivitas fisik dan makan makanan yang sehat</li>
 <li>Terlibat dalam kegiatan</li>
 <li>Memiliki rasa pencapaian</li>
 <li>Bisa bersantai dan tidur nyenyak</li>
 <li>Merasa nyaman di komunitas mereka.</li></ul>

 <h4>Upaya Menjaga Kesehatan Mental bagi Remaja:</h4>
 <p align='justify'>Berbicara dari hati ke hati dengan anak remaja Anda tentang kondisi dan 
    kesehatan mentalnya adalah langkah awal yang perlu Anda lakukan sebagai orangtua. 
    Jika Anda mengkhawatirkan kesehatan mental anak, mulailah dengan mengajaknya berbicara. 
